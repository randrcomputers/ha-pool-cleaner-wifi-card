...
3. Optional: copy artwork from [ha-pool-cleaner-card/pool_card](https://github.com/randrcomputers/ha-pool-cleaner-card/tree/main/pool_card) to `config/www/pool_card/`
